...
for index, row in original.iterrows():
    ...
    tokens_without_stopwords = [
        ...
        if (word not in stop_words and word not in punctuation and word != "''" and word != "``")
    ]
    new_sentence = ''
...
topics_data.to_csv('../preprocessed_dataset/kaggle_dataset.csv', index=False)

with open('../preprocessed_dataset/word_dict_kaggle_dataset.json', 'w') as fp:
